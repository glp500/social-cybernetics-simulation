...
Introduced the complete analysis contract at commit `906020631dab9c4b1d73efa95dcb864ad71363fb` and
froze its simplified validator at `35dc0332864ab9bf7d4aafcfdcc5bb578ed0daf1`. Analysis bundle schema
v1.1 retains the 140 nested/raw
...
than scientific results. `just check` passed 263 tests at 90.86% branch-aware coverage, Ruff, Pyright,
